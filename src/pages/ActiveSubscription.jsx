...
const statusClass = { Active: 'badge badge-active', Expiring: 'badge badge-warning', Inactive: 'badge badge-inactive' };
  ...
  return (
    <div className="page-body">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          { label: 'Total Active', value: '4', color: 'bg-green-100 text-green-700' },
          { label: 'Expiring Soon', value: '1', color: 'bg-yellow-100 text-yellow-700' },
          { label: 'Inactive', value: '1', color: 'bg-red-100 text-red-700' },
          { label: 'Monthly Revenue', value: '$997', color: 'bg-indigo-100 text-indigo-700' },
        ].map(s => (
            ...
            <tbody>
              {SUBS.map(s => (
                <tr key={s.id} className="table-row-hover hover:bg-indigo-50/40">
                  ...
                  <td className="table-td"><span className="badge badge-trial">{s.plan}</span></td>
                  ...
                  <td className="table-td"><span className={statusClass[s.status] || 'badge'}>{s.status}</span></td>
