  ...
  return (
    <div className="page-body">
      <div className="space-y-3">
        <div className="mb-8">
          <h1 className="text-[30px] text-[#000000] font-bold leading-snug">Dashboard</h1>
          <p className="text-[24px] font-normal text-[#6B7280] -mt-[6px]">Welcome back, Super Admin. Here's what's happening.</p>
        </div>
        <StatsCards />
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <div className=" min-h-0"><StudentGrowth /></div>
